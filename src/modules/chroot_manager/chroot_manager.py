...
class ChrootManager:
    def __init__(self, chroot_destination: str):
        ...
        self.mount_points = ['/proc', '/sys', '/dev', '/run']
    ...
    def mount(self):
        ...
        for mount_point in self.mount_points:
            ...
            if mount_point == '/dev':
                ...
                executer.run(f'mount --rbind {mount_point} {target_path}')
    ...
    def run_command(self, command):
        ...
        executer.run(f'chroot {self.destination} /bin/bash -c {command}', capture_output=False)
