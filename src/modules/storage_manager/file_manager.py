...
class FileManager:
    ...
    def copy_live_system_to_usb(self, usb_mount_path):
        ...
        rootfs_squash_path = os.path.join(self.squashfs_path, 'filesystem.squashfs')
        ...
        shutil.copy2(rootfs_squash_path, f'{usb_mount_path}/live')
        shutil.copy2(vmlinuz_path, f'{usb_mount_path}/live')
        shutil.copy2(initrd_path, f'{usb_mount_path}/live')
